...
namespace DZAFCPortal.Utility
{
    public class DBHelper
    {
        ...
        {
            ConnectionStringLocalTransaction = conn;
        }
        ...
        public void EndTransaction(SqlTransaction tran)
        {
        ...
        {
            return ExecuteNonQuery(ConnectionStringLocalTransaction, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteReader(ConnectionStringLocalTransaction, cmdType, cmdText, commandParameters);
        }
        ...
        public object ExecuteScalar(CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            return ExecuteScalar(ConnectionStringLocalTransaction, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteDataSet(ConnectionStringLocalTransaction, cmdType, cmdText, commandParameters);
        }
        ...
        /// 无参数的query
        /// </summary>
        /// <remarks>Zhanxl</remarks>
        /// <param name="connectionString"></param>
        /// <param name="cmdType"></param>
        /// <param name="cmdText"></param>
        /// <returns></returns>
        public DataTable ExecuteDataTableNonePara(string connectionString, CommandType cmdType, string cmdText)
        {
            SqlCommand cmd = new SqlCommand();
            SqlConnection conn = new SqlConnection(connectionString);
            try
            {
                PrepareCommand(cmd, conn, null, cmdType, cmdText, new SqlParameter[] { });
        ...
        public DataTable ExecuteDataTableNonePara(CommandType cmdType, string cmdText)
        {
            return ExecuteDataTableNonePara(ConnectionStringLocalTransaction, cmdType, cmdText);
        }
        #endregion
    }
}
