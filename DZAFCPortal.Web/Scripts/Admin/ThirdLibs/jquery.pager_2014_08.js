...
(function ($) {
    ...
    $.fn.pager = function (options) {
        ...
        opts.firsttext, opts.prevtext, opts.nexttext, opts.lasttext, opts.recordtext, opts.gotext, parseInt(opts.numericButtonCount)));
    ...
    function renderpager(pagenumber, pagecount, recordcount, buttonClickCallback, firsttext, prevtext, nexttext, lasttext, recordtext, gotext, numericButtonCount) {
        ...
        var startPoint = 1;
        var endPoint = numericButtonCount + 1;
        var middlePoint = (numericButtonCount - numericButtonCount % 2) / 2;

        if (pagenumber > pagecount) {
            pagenumber = pagecount;
        }
        if (pagenumber > middlePoint) {
            startPoint = pagenumber - middlePoint;
            endPoint = pagenumber + middlePoint;
        }

        if (endPoint > pagecount) {
            startPoint = pagecount - middlePoint * 2;
            endPoint = pagecount;
        }
    ...
    $.fn.pager.defaults = {
        ...
        numericButtonCount: 8 //显示的按钮数 1 2 3 4 5... 设置为0则表示不显示
    };
