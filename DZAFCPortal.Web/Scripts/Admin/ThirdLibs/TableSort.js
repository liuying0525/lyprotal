    ...
    sorttable: function (setting) {
        ...
        headCells.each(function () {
            if (configer.ascImgUrl != "" && configer.descImgUrl != "") {
                $($.parseHTML("&nbsp;<img class='asc' src='" + configer.ascImgUrl + "' style='width:" + configer.ascImgSize + "; height:" + configer.ascImgSize + ";display:none;' title='升序' alt='升序'/>")).appendTo($(this));
                $($.parseHTML("&nbsp;<img class='desc' src='" + configer.descImgUrl + "' style='width:" + configer.descImgSize + "; height:" + configer.descImgSize + ";display:none;' title='降序' alt='降序'/>")).appendTo($(this));
            }
            else {
                $($.parseHTML("&nbsp;<span class='asc' style='width:12px; height:12px;display:none;' title='升序'>&#118;</span>")).appendTo($(this));
                $($.parseHTML("&nbsp;<span class='desc' style='width:12px; height:12px;display:none;' title='降序'>&#94;</span>")).appendTo($(this));
            }
        ...
        headCells.click(function () {
            ...
            if (lock == false) {
                ...
                if (configer.allowMask) {
                    ...
                    // 添加遮罩层
                    var mark = $($.parseHTML("<div></div>")).attr("id", "TableSort_Mark").css("background-color", configer.maskColor).css("position", "absolute").css("top", tTop + "px").css("left", tLeft + "px").css("opacity", configer.maskOpacity).css("z-index", "9999").css("width", tw + "px").css("height", th + "px");
