<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleOrgChooseControl.ascx.cs" Inherits="DZAFCPortal.Web.Client.Controls.SingleOrgChooseControl" %>
...
<%--<script src="/Scripts/Client/js/chooseSingleOrg.js"></script>--%>
...
<style type="text/css">
    ...
    .chosenDeptNamecloae {
        background-image:url("/Scripts/Client/images/removeCurrent_close.png");
