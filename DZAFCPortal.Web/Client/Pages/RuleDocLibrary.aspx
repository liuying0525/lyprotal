    ...
    <div class="ny_container">
        ...
        <div class="ny_mainlist ny_container_boxshadow fr">
            ...
            <div class="ny_mainlist_info">
                <iframe frameborder="0" id="iframepage" height="400px" width="100%" scrolling="no" src="http://192.168.181.11/SitePages/DocLibrary.aspx?RootFolder=%2FDocLib%2F01%E8%A7%84%E7%AB%A0%E5%88%B6%E5%BA%A6&FolderCTID=0x01200092C746EDFC4DB244BC64FAF1E180F6F1&View=%7B06D0DDAE-5C56-4DF2-B705-DD89D9CA4BDE%7D"></iframe>
            </div>
        </div>
    </div>
    <style type="text/css">
