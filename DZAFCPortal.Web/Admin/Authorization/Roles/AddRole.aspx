<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../../BaseLayout.Master" CodeBehind="AddRole.aspx.cs" Inherits="DZAFCPortal.Web.Admin.Roles.AddRole" %>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCode" runat="server" CssClass="form-control txt_width_md"></asp:TextBox><span style="color: red">* <span id="spanCode"></span></span>
                </td>
            </tr>
            <tr>
                <td>角色类型：
            ...
            <tr>
                <td colspan="2" class="text-center">
                    ...
                    <asp:LinkButton ID="btnSave" runat="server" Text="保存" OnClick="btnSave_Click" CssClass="btn-primary btn" OnClientClick="return validateForm();">
