<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NavigatorMgt.aspx.cs" Inherits="DZAFCPortal.Web.Admin.NavMgt.NavigatorMgt" %>
            ...
            $("form").ajaxForm({
                ...
                success: function (data) {
                    ...
                    if (res.IsSucess) {
                        ...
                        navJs.currentModel.IconPath(source);
            ...
            <div class="center_right fr" data-bind="visible: navJs.currentModel.isOnclick">
                ...
                <table class="table table-bordered BEA_table" style="background-color: #f3f3f3; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; overflow: hidden;">
                    ...
                    <tr>
                        <td>可见范围</td>
                        <td>
                            <select data-bind=" value: navJs.currentModel.visibleScope, event: { change: visibleChanged }" class=" form-control">
