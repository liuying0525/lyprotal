<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChooseSingleUser.ascx.cs" Inherits="DZAFCPortal.Web.Admin.Controls.ChooseSingleUser" %>
<!-- Ztree 脚本和样式 -->
<link href="/Scripts/Admin/ThirdLibs/zTree_v3/css/zTreeStyle/zTreeStyle.css" rel="stylesheet" type="text/css" />
<script src="/Scripts/Admin/ThirdLibs/zTree_v3/js/jquery.ztree.core-3.5.js" type="text/javascript"></script>
...
<div id="div_Choose" class="div_Choose_container">
    ...
    <div id="bookRight">
        <div>
            ...
            <a class="BEA_btn_submit fr" style="line-height: 17px;cursor:pointer" data-bind=" click: sureChecked">确&nbsp;&nbsp;认</a> <span id="errorMsg" style="color: red"></span>
            <div class="clear"></div>
            <hr />
        </div>
