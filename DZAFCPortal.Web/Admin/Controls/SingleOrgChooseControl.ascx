<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleOrgChooseControl.ascx.cs" Inherits="DZAFCPortal.Web.Admin.Controls.SingleOrgChooseControl" %>
<!-- Ztree 脚本和样式 -->
...
<div id="<%=ContainerID %>" name="chooseOrgContainer">
   ...
   <span name="chosenDeptID" id="DepId" style="display:none;"><%=ChosenDeptId %></span>
