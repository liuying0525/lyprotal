<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UploadAttach3.ascx.cs" Inherits="DZAFCPortal.Web.Admin.Controls.UploadAttach3" %>
            ...
            <div class="modal-dialog" style="padding-top: 84px;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-default" data-dismiss="modal" aria-hidden="true" onclick="GetAttachList()">
