<%@ Page Language="C#" MasterPageFile="../../BaseLayout.Master" AutoEventWireup="true" CodeBehind="AddLink.aspx.cs" Inherits="NYPortal.Web.SMGPages.Links.AddLink" %>
    ...
    <div class="BEA_div_bg">
        ...
        <table class="table table-bordered">
            ...
            <tr style="display:none">
                ...
                <td>
                    <asp:TextBox ID="txtShortName" runat="server" class="form-control txt_width_lg"></asp:TextBox>
                </td>
            </tr>
            <tr runat="server" id="tr_IndexIcon">
                <td>首页图标：</td>
                <td>
